...
private ["_OBJ","_Type","_dieOut","_size"];
_OBJ = _this select 0;
...
//\Ca\Data\ParticleEffects\FireAndSmokeAnim\SmokeAnim.p3d
		...
		_PS3 setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\SmokeAnim.p3d", 8, 1, 6], "", "Billboard", 1, 8, [0, 0, 0], [0, 0, 4.5], 0, 10, 7.9, 0.5, [4, 12, 20], [[0.1, 0.1, 0.1, 0.8], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.125], 1, 0, "", "", _OBJ];
		_PS3 setDropInterval 0.5;
