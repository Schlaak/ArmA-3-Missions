...
sleep 3;
{_x addMPEventHandler ["MPhit", { [_this select 0] spawn fn_L917_incap; }];} foreach allunits;
sleep 3;
{_x addMPEventHandler ["MPKilled", { [_this select 0] spawn fn_L917_Blut; [_this select 0] call fn_L917_KIA; }]; } foreach allunits;