/*
  ...
  Examples:
    nul = [gl1,gl2,50] execvm "02_scripts\shk_moveobjects.sqf"
    nul = [start,destination,100,"Man"] execvm "02_scripts\shk_moveobjects.sqf"
    nul = [[3243,5234,0],gl2,50,["Man","Car"]] execvm "02_scripts\shk_moveobjects.sqf"
    nul = [gl1,gl2,50,[],gl2] execvm "02_scripts\shk_moveobjects.sqf"
    nul = [gl1,gl2,50,[],45] execvm "02_scripts\shk_moveobjects.sqf"
    nul = [gl1,gl2,50,[],45,270] execvm "02_scripts\shk_moveobjects.sqf"
