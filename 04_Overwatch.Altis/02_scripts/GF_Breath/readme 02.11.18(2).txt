...
GF Breath Script , breath particles , for Cold weather conditions.
...
For usage instructions and information of how to use the GF Breath Script please refer to the included documentation and/or example mission.
...
Breath particles , for Cold weather conditions.
The particles will spawn according the fatigue.
...
v2.0
Fixed , the cycle of breathing particle , depending on fatique.
Added an exclude headgear list.

v1.1
Fixed , the particle was spawned ,on dead units 
...
Forum topic:
- BI forums https://forums.bohemia.net/forums/topic/220057-gf-breath-script/?tab=comments#comment-3321376
- Armaholic forums http://www.armaholic.com/forums.php?m=posts&q=40267&n=last#bottom
