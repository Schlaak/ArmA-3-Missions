...
[
[[7253.32,8081.99,0],500],
[[7262.64,7872.79,0],500]
];


private _groundClutter = ["Land_Garbage_square3_F","Land_Garbage_square5_F","Land_Garbage_line_F","MedicalGarbage_01_3x3_v2_F","MedicalGarbage_01_3x3_v1_F","MedicalGarbage_01_5x5_v1_F","MedicalGarbage_01_1x1_v3_F","Land_dirt_road_damage_long_01_F",
...
private _extraTrash = ["Land_GarbageHeap_02_F","Land_GarbageHeap_01_F","Land_GarbageBags_F","Land_GarbagePallet_F","Land_GarbageWashingMachine_F","Land_GarbageHeap_04_F","Land_GarbageHeap_03_F","Land_Barricade_01_4m_F","Oil_Spill_F","Land_Garbage_square3_F","Land_Garbage_square5_F","Land_Garbage_line_F","MedicalGarbage_01_3x3_v2_F","MedicalGarbage_01_3x3_v1_F","MedicalGarbage_01_5x5_v1_F","MedicalGarbage_01_1x1_v3_F"];
private _randomWreaks = ["Land_Wreck_BMP2_F","Land_Wreck_BRDM2_F","Land_Wreck_AFV_Wheeled_01_F","Land_Wreck_HMMWV_F","Land_Wreck_Hunter_F","Land_Wreck_Car_F","Land_Wreck_Skodovka_F","Land_Wreck_Ural_F","Land_Wreck_MBT_04_F","Land_Wreck_LT_01_F","Land_V3S_wreck_F","Land_Wreck_Truck_F","Land_Wreck_Car2_F","Land_Tyres_F","Land_Wreck_Van_F","Land_Wreck_Truck_dropside_F","Land_Wreck_Offroad2_F"];
private _counter = 0;
...

  {
    _dir = 360;
      ...
      if (_rndNum < _per1) then {
        ...
        if (_obj iskindof "Land_Decal_RoadEdge_Dirt_06_F") then
        {
          [_obj, 3] remoteExec ["setobjectscale", 0];
        };
