/*
	...
	[[line1,line2],"SIDE",0.15,true] execVM "02_scripts\fn_simpleConv.sqf";
...
for "_i" from 0 to (count _lines) - 1 do
{
	...
	//Schlaakedit
	//if (isserver) then {
	_talk = selectrandom ["talk1","talk2","talk3"];
	[_speaker,[_talk,40,1,true]] remoteExec ["say3D", player, False];};
