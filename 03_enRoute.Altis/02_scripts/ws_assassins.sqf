...
nul = [this OR unitname OR true,"weaponclass",chance (1-100),triggerarea (int),side OR unitname] execVM "02_scripts\ws_assassins.sqf";
With optional parameters:
nul = [this OR unitname OR true,"weaponclass",chance (1-100),triggerarea (int),side OR unitname,number of targets present (1-n),skill mod (0-1)] execVM "02_scripts\ws_assassins.sqf";
...
//
// EXAMPLES
// nul = [this,"CUP_hgun_Makarov",(40+random 35),10,resistance,1,1] execVM "02_scripts\ws_assassins.sqf";
...
//
// nul = [azim,"ran",100,10,east,2,random 0.8] execVM "02_scripts\ws_assassins.sqf";
...
//
// nul = [true,"LMG_Zafir_F",(20 + random 20),10,mark,1,0.5] execVM "02_scripts\ws_assassins.sqf";
...
if (_check) exitWith {
	...
	{[_x,_weapon,_chance,_trgsize,_target1,_target2,_skill] execVM "02_scripts\ws_assassins.sqf";} forEach _civarray;
