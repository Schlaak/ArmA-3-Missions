...
switch ((paramsArray select 0)) do	//playerside
{
    ...
    case 1: //1 West
    {
		...
		//amor
		O_grpTank1 = (configfile >> "CfgGroups" >> "East" >> "CWR3_RUS" >> "Armored" >> "cwr3_o_t72b1_platoon");
		O_grpTank2 = (configfile >> "CfgGroups" >> "East" >> "CWR3_RUS" >> "Armored" >> "cwr3_o_t72_platoon");
		O_grpTank3 = (configfile >> "CfgGroups" >> "East" >> "CWR3_RUS" >> "Armored" >> "cwr3_o_t55_platoon");

		//Mechanized
		B_grpMech1 = (configfile >> "CfgGroups" >> "WEST" >> "CWR3_USA" >> "Mechanized" >> "cwr3_b_mechanized_infantry_m2a2");
		B_grpMech2 = (configfile >> "CfgGroups" >> "WEST" >> "CWR3_USA" >> "Mechanized" >> "cwr3_b_mechanized_infantry_m113");
		B_grpMech3 = (configfile >> "CfgGroups" >> "WEST" >> "CWR3_USA" >> "Mechanized" >> "cwr3_b_mechanized_infantry_m113");
		...
		// armor
		B_grpTank1 = (configfile >> "CfgGroups" >> "West" >> "CWR3_USA" >> "Armored" >> "cwr3_b_m60_platoon");
		B_grpTank2 = (configfile >> "CfgGroups" >> "West" >> "CWR3_USA" >> "Armored" >> "cwr3_b_m1a1_platoon");
    };
    case 2: //independent
    {
        //TODO
...
O_grp_arr_Tank = [O_grpTank1,O_grpTank2,O_grpTank3,O_grpTank3,O_grpTank3];
...
B_grp_arr_Tank = [B_grpTank1,B_grpTank1,B_grpTank1,B_grpTank2];
